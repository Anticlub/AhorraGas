...
public class PricesFragment extends Fragment {
    ...
    public static PricesFragment newInstance(Gasolinera gasolinera) {
        ...
        for (com.ahorragas.app.model.FuelType fuel : com.ahorragas.app.model.FuelType.values()) {
        ...
        if (gasolinera.isElectric() && gasolinera.getConectores() != null) {
            ...
            for (int i = 0; i < gasolinera.getConectores().size(); i++) {
                com.ahorragas.app.model.Electrolinera.Conector c =
        ...
        if (isElectric) {
            ...
            if (conectoresRaw.isEmpty()) {
                ...
                for (String item : items) {
                    ...
                    com.ahorragas.app.model.ConnectorType tipo =
                            com.ahorragas.app.model.ConnectorType.valueOf(parts[0]);
                    String modo = parts[1];
                    double potenciaW = 0;
